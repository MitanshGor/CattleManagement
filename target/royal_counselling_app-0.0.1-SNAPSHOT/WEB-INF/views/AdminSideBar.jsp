				...
				<ul class="navbar-nav flex-column">
					...
					<li class="nav-item "><a class="nav-link"
						...
						data-target="#submenu-1" aria-controls="submenu-1"><i
							class="fa fa-fw fa-user-circle" active></i>Admin Management</a> <a
						class="nav-link" href="#" aria-expanded="false"
						data-target="#submenu-1" aria-controls="submenu-1"><i
							class="fas fa-address-card"></i>User Management<span
							class="badge badge-success">6</span></a> <a class="nav-link" href="#"
						...
						aria-controls="submenu-1"><i class=" fas fa-link"></i>Link
							Management<span class="badge badge-success">6</span></a></li>
				</ul>
			</div>
